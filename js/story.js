// As Per My Last Email — story content.
...
export const CHARACTERS = {
  ...
  priya: { name: "Gary", img: "portrait-priya", sprite: "sprite-priya", title: "The Competent One", voice: 340 },
  marcus: { name: "Brian", img: "portrait-marcus", sprite: "sprite-marcus", title: "The Credit Thief", voice: 180 },
  becky: { name: "Emily", img: "portrait-becky", sprite: "sprite-becky", title: "The Boss's Favorite", voice: 400 },
  owen: { name: "Todd", img: "portrait-owen", sprite: "sprite-owen", title: "The Anxious Overworker", voice: 300 },
...
export const INBOX = {
  1: [
    { from: "Linda (Manager)", subject: "Exciting Growth Opportunity", preview: "One of you will be promoted to Senior Project Lead by Friday…" },
    { from: "Brian", subject: "RE: Exciting Growth Opportunity", preview: "Thrilled to help steer the team through this transition." },
    { from: "Gary", subject: "[DM] did he just…", preview: "Did he just imply he's already leading the project?" },
    { from: "Emily", subject: "🏆", preview: "(reacted to Linda's message with a trophy)" },
  ],
  2: [
    { from: "Linda (Manager)", subject: "Team demo — Wednesday", preview: "I want ONE deck from the whole team. Coordinate. No drama." },
    { from: "Todd", subject: "i can take the boring slides", preview: "happy to do the appendix. and the charts. and the notes." },
  ...
  3: [
    ...
    { from: "Brian", subject: "not me btw", preview: "Just want to say publicly that this wasn't on my end." },
    { from: "Gary", subject: "[DM] this is weird", preview: "The file that broke… it was fine yesterday. Was it?" },
  ],
  4: [
    { from: "Linda (Manager)", subject: "Quick chats today", preview: "Grabbing each of you for ten minutes. Just checking in. :)" },
    { from: "Emily", subject: "ugh meetings", preview: "if anyone asks I was 'in the field'" },
    { from: "Todd", subject: "should i be worried", preview: "should i be worried" },
  ],
  5: [
    { from: "Linda (Manager)", subject: "Decision — 4:00 PM", preview: "Thank you all. I've made up my mind. See you in the big room." },
  ],
};
...
export const SCENES = {
  ...
  d1_morning: {
    ...
    beats: [
      ...
      { text: "Brian immediately replies-all to the entire company." },
      { speaker: "marcus", text: "Thrilled to help steer the team through this transition!" },
      { text: "Your phone buzzes. A private message from Gary." },
      { speaker: "priya", text: "…did he just imply he's already leading the project?" },
      { text: "Emily reacts to Linda's announcement with a single trophy emoji." },
    ],
    auto: "d1_reply",
  },
  d1_reply: {
    ...
    beats: [{ text: "Everyone can see what you do next. So can Linda." }],
    choices: [
      ...
      { text: "Privately agree with Gary.", hint: "Build a quiet alliance. Nobody else sees it.", rel: { priya: 2 }, set: ["priyaWarm"], next: "d1_after_reply" },
      { text: "Reply-all with a subtle correction.", hint: "“Looking forward to seeing everyone's contributions recognized.” Bold.", effects: { reputation: 1, suspicion: 1 }, rel: { marcus: -2, dana: 1 }, set: ["correctedBrian"], next: "d1_after_reply" },
  ...
  d1_after_reply: {
    ...
    beats: [
      { text: "Todd corners you, vibrating with caffeine." },
    ...
    choices: [
      { text: "Gently tell him to slow down.", hint: "Decent of you. Todd remembers kindness.", rel: { owen: 2 }, next: "d1_marcus" },
  ...
  d1_marcus: {
    day: 1,
    phase: "work",
    title: "Brian finds you",
    beats: [
      { text: "Brian leans on your desk like he owns it." },
      { speaker: "marcus", text: "Between us — Gary's good, but he can't lead. People skills, you know? You and me should make sure the right person gets this." },
  ...
  d1_recap: {
    ...
    beats: [
      ...
      { text: "You've started to see who's dangerous: Brian plays politics, Gary is the real threat on merit, Emily floats above it all, and Todd would walk into traffic for a compliment." },
    ],
    auto: "d2_morning",
  },
  ...
  d2_morning: {
    ...
    beats: [
      { text: "Linda drops a single line in the team channel." },
  ...
  d2_priya: {
    ...
    choices: [
      { text: "Give honest, helpful feedback.", hint: "Gary gets even better. You gain a real ally.", rel: { priya: 2 }, effects: { chaos: -1 }, set: ["helpedGary"], next: "d2_credit" },
      { text: "Suggest 'adding more technical detail.'", hint: "His slides get denser, harder to follow. Plausibly innocent.", effects: { chaos: 1 }, set: ["sabotagedDeck"], next: "d2_credit" },
      { text: "Offer to 'polish' the deck yourself.", hint: "You hold the file. You could change anything. Version history exists, though.", effects: { suspicion: 1 }, rel: { priya: 1 }, set: ["holdsGaryDeck"], next: "d2_credit" },
      { text: "Tell Brian that Gary is nervous.", hint: "Aim two rivals at each other. Unpredictable.", effects: { chaos: 1, suspicion: 1 }, rel: { marcus: 1 }, set: ["sicBrianOnGary"], next: "d2_credit" },
    ],
  },
  d2_credit: {
    day: 2,
    ...
    beats: [
      ...
      { text: "Brian is already photographing it." },
      { speaker: "marcus", text: "Mm. Love where my thinking is going here." },
    ],
    choices: [
      { text: "Claim it first, loudly.", hint: "Take credit before Brian can. Big reputation, real risk.", effects: { reputation: 2, suspicion: 2 }, rel: { marcus: -2 }, set: ["tookCredit"], next: "d2_owen" },
      { text: "Quietly note who actually wrote it.", hint: "Information for later. No glory now.", set: ["knowsIdeaAuthor"], next: "d2_owen" },
      { text: "Let Brian take it — and overcommit him.", hint: "“Great, then YOU can present it to the CEO.” Hand him a rope.", effects: { chaos: 1 }, rel: { marcus: 1 }, set: ["marcusOverpromised"], next: "d2_owen" },
      { text: "Credit Gary for it, generously.", hint: "Costs you the spotlight, buys deep trust.", rel: { priya: 2, marcus: -1 }, effects: { reputation: -1 }, set: ["championedGary"], next: "d2_owen" },
    ],
  },
  d2_owen: {
    day: 2,
    phase: "work",
    title: "Todd is drowning",
    beats: [
      { text: "Todd has somehow volunteered for half the deck and it shows — pale, twitchy, fourth energy drink." },
    ...
    choices: [
      ...
      { text: "Quietly take the good slides off his plate.", hint: "You present the strong parts; he keeps the appendix. Subtle credit grab.", effects: { reputation: 1, suspicion: 1 }, set: ["pinchedToddsSlides"], next: "d2_recap" },
    ],
  },
  d2_recap: {
    day: 2,
  ...
  d3_morning: {
    ...
    beats: [
      ...
      { text: "Nobody will admit to the last change. Linda is calm in the way that is much scarier than shouting." },
  ...
  d3_blame: {
    ...
    choices: [
      ...
      { text: "Point out Brian's 'not me' email was awfully fast.", hint: "Redirect scrutiny onto Brian. He'll retaliate.", effects: { suspicion: 1, chaos: 1 }, rel: { marcus: -2 }, set: ["blamedBrian"], next: "d3_coverup" },
  ...
  d3_coverup: {
    day: 3,
    phase: "work",
    title: "Gary pulls you aside",
    beats: [
      { speaker: "priya", text: "I checked the history. The break came from the deck branch. The one that got… reorganized on Tuesday." },
      { text: "He doesn't say your name. He's watching your face to see if he needs to." },
    ],
    choices: [
      { text: "Come clean to Gary.", hint: "Honesty, if you've got something to confess. Costs reputation, may buy a fierce ally.", effects: { suspicion: -1, reputation: -1 }, rel: { priya: 2 }, set: ["confessedToGary"], next: "d3_rumor" },
      { text: "Act baffled and concerned.", hint: "“Tuesday? Weird. We should tell Linda.” Deflect smoothly.", effects: { suspicion: 1 }, rel: { priya: -1 }, next: "d3_rumor" },
      { text: "Suggest it was Brian's reorg.", hint: "He did touch the deck branch… didn't he? Plant the idea.", effects: { chaos: 1, suspicion: 1 }, rel: { marcus: -1, priya: -1 }, set: ["framedBrian"], next: "d3_rumor" },
      { text: "Remind him you championed his work.", hint: "Cash in goodwill so he lets it drop.", require: { flag: "championedGary" }, rel: { priya: 1 }, effects: { suspicion: -1 }, next: "d3_rumor" },
    ],
  },
  d3_rumor: {
    day: 3,
    phase: "work",
    image: "scene-kitchen",
    title: "Emily has heard things",
    beats: [
      { text: "Emily materializes with a fancy coffee." },
      { speaker: "becky", text: "Okay so everyone's saying the project's a disaster and someone did it on purpose. Wild, right?" },
      { text: "Whatever you tell Emily, the whole office will know by lunch. She is a broadcast tower in cardigan form." },
    ],
    choices: [
      ...
      { text: "Feed her a rumor about Brian.", hint: "Weaponize the broadcast tower. Effective, traceable.", effects: { chaos: 1, suspicion: 1 }, rel: { marcus: -2, becky: 1 }, set: ["spreadRumor"], next: "d3_recap" },
      { text: "Befriend her properly.", hint: "Emily is untouchable — better as an ally than a weapon.", rel: { becky: 2 }, effects: { allies: 1 }, set: ["beckyAlly"], next: "d3_recap" },
  ...
  d3_recap: {
    ...
    beats: [
      ...
      { text: "Linda has started writing things down. That's never good." },
    ],
    auto: "d4_morning",
  },
  ...
  d4_morning: {
    ...
    beats: [
      { text: "Linda is doing one-on-ones with the energy of a detective who already knows." },
  ...
  d4_dana: {
    ...
    beats: [
      { text: "Linda slides a notepad across the table." },
    ...
    choices: [
      { text: "Own your role honestly.", hint: "Admit what you actually did. Costs reputation, drops suspicion hard. Linda values candor.", effects: { suspicion: -3, reputation: -1 }, rel: { dana: 2 }, set: ["cameClean"], next: "d4_owen" },
      ...
      { text: "Steer her toward Brian.", hint: "Offer your 'pattern.' Risky if she's smarter than you.", effects: { suspicion: 1, chaos: 1 }, rel: { marcus: -2, dana: -1 }, set: ["soldOutBrian"], next: "d4_owen" },
  ...
  d4_owen: {
    day: 4,
    phase: "work",
    title: "Todd is about to confess",
    beats: [
      { text: "Todd finds you, gray-faced." },
      { speaker: "owen", text: "I think it was me. The build. I'm going to tell Linda everything. Including the stuff I saw other people do." },
      { text: "“Everything” is a big word. He has seen a lot this week." },
    ],
    choices: [
      { text: "Talk him off the ledge kindly.", hint: "Protect Todd from himself. Steadies things; he never forgets it.", effects: { chaos: -1, stress: 1 }, rel: { owen: 3 }, set: ["savedTodd"], next: "d4_alliance" },
      { text: "Encourage the confession — aimed away from you.", hint: "Let him fall on the grenade. Coach which parts to share.", effects: { suspicion: -1, chaos: 1 }, rel: { owen: -1 }, set: ["usedTodd"], next: "d4_alliance" },
  ...
  d4_alliance: {
    ...
    beats: [
      ...
      { text: "He extends a tentative truce." },
    ],
    choices: [
      ...
      { text: "Shake hands. Plan to break it.", hint: "Let him relax, then take the shot tomorrow. High risk.", effects: { suspicion: 1 }, rel: { priya: 1 }, set: ["falsePact"], next: "d4_recap" },
  ...
  d4_recap: {
    ...
    title: "End of Day 4",
    beats: [
      { text: "Linda closes her notebook. You can't tell if that's good or very bad." },
  ...
  d5_morning: {
    ...
    beats: [
      { text: "4:00 PM. The big room. Linda, the rivals, and a decision that's basically already made — except for the part where you talk." },
  ...
  d5_twist: {
    ...
    beats: [
      { text: "Emily, of all people, speaks first." },
    ...
    choices: [
      { text: "Expose Emily with evidence.", hint: "Turn the twist on her — strongest if you kept receipts or befriended her.", require: { anyFlag: ["screenshotMonday", "beckyAlly", "usedReceipts"] }, effects: { reputation: 2, suspicion: -1 }, rel: { becky: -2, dana: 2 }, set: ["exposedEmily"], next: "d5_final" },
  ...
  d5_final: {
    ...
    title: "Linda decides",
    beats: [
      { text: "Linda looks at her notebook one last time, then closes it for good." },
